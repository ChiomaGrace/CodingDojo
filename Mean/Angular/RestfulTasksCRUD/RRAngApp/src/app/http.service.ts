...
export class HttpService {
  ...
  submittedTaskService(submittedTask){
    // console.log(submittedTask, "This is the submit task service")
    return this._http.post('/tasks', submittedTask)
  }

  updateTaskService(updateTask, taskId){
    console.log("This is the update task service",updateTask, taskId)
