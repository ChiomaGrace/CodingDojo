...
# eg. "User: Guido van Rossum, Balance: $150
    ...
    def displayUserAndBalance(self):
        ...
        print(f"Hi, {self.name}! Your current balance is: {self.ba.balance} dollars.")
        return self
...
# BONUS: transfer_money(self, other_user, amount) - have this method decrease the user's balance by the amount and add that amount to other other_user's balance
    ...
    def transferMoney(self, amount, recipient):
        # self.balance -= amount
        self.ba.balance
        recipient.ba.balance += amount
        print(f"Your money transfer of {amount} to {recipient.name} is complete. Your current balance is {self.ba.balance}.")
